...
This project is indexed by GitNexus as **TenderBot** (98800 symbols, 305309 relationships, 1171 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/TenderBot/context` | Codebase overview, check index freshness |
| `gitnexus://repo/TenderBot/clusters` | All functional areas |
| `gitnexus://repo/TenderBot/processes` | All execution flows |
| `gitnexus://repo/TenderBot/process/{name}` | Step-by-step execution trace |
